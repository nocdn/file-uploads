...
Configure the extension preferences with your R2 S3 API endpoint, Access Key ID, Secret Access Key, and bucket name. Use the account-level endpoint without the bucket path, for example `https://<ACCOUNT_ID>.r2.cloudflarestorage.com`.
